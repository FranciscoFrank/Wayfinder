...
class AdminSettingsForm extends ConfigFormBase {
   ...
   *   The module handler service.
   */
  public function __construct(ConfigFactoryInterface $config_factory, ExcludeNodeTitleManagerInterface $exclude_node_title_manager, EntityTypeBundleInfoInterface $entity_bundle_info, EntityDisplayRepositoryInterface $entity_display_repository, ModuleHandlerInterface $module_handler, TypedConfigManagerInterface $typed_config_manager) {
