...
class CssW3Form extends BaseValidatorForm {
  ...
  private function testW3C($filename, array &$validator_options = []) {
    ...
    try {
      ...
      DeprecationHelper::backwardsCompatibleCall(\Drupal::VERSION, '10.1.0', fn() => Error::logException(\Drupal::logger('AdvAgg Validator'), $e), fn() => watchdog_exception('AdvAgg Validator', $e));
    }
    catch (\Exception $e) {
      DeprecationHelper::backwardsCompatibleCall(\Drupal::VERSION, '10.1.0', fn() => Error::logException(\Drupal::logger('AdvAgg Validator'), $e), fn() => watchdog_exception('AdvAgg Validator', $e));
    }
